...
Store durable, non-sensitive learnings from competitor livestream analysis. Do not store raw comments, transcripts, screenshots, or private viewer data.

## Competitor Pattern Index

| Date | Platform | Competitor/Account | Product | Pattern | Source Pointer |
| --- | --- | --- | --- | --- | --- |
| 2026-05-19 | Douyin | 率土之滨 保安队长 | 率土之滨 | Expert diagnosis live room: uses game/account/team screens plus comment-driven Q&A around team viability, account review, and lineup advice. | recordings/douyin-live-20260519-002034-analysis.md |
...
- CTA patterns:
- Moderator/pinned-comment patterns:
- Account/team diagnosis loop: invite viewers to provide account or lineup context, give a direct viability judgment, explain the key gap, then recommend the next build or resource action.
...
- Trust/authenticity:
- Product suitability:
- Gameplay or feature confusion:
- Purchase/reward path:
- Technical issues:
- Strategy-game deep-player objections: "Can this low-investment/whiteboard team work?", "How should I configure this account?", "Is this account worth buying?", "How many viable teams can this account form?"
...
- A tactic is stronger when anchor script, comment response, and visual proof all reinforce the same claim.
- Repeated comments without a pinned answer indicate an opportunity for better live room information architecture.
- High urgency without clear proof can drive short-term conversion but may weaken trust.
- High comment volume around price should be analyzed together with offer clarity and package framing.
